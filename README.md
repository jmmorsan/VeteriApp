...
**VeteriApp** es un ecosistema digital integral para la gestión de servicios veterinarios, diseñado para transformar la interacción tradicional entre el centro clínico y el propietario de la mascota. El software combina la robustez de un sistema de gestión clínica (ERP) con la sensibilidad de un espacio conmemorativo único❤️‍🩹⭐​🌈​.
...
*   **Modulo Memorial**: Activity donde recoge a todas aquellas mascotas que ya no estan con nosotras y hacer su recuerdo eterno en un sistema tan humano como VeteriApp​❤️‍🩹​⭐​🌈​.
...
1.  **Clonar el repositorio**:
    ```bash
    git clone https://github.com/jmmorsan/VeteriApp
    ```
